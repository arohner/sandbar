...
The project contains the library code as well a reference project which uses the library.
...
There will be no code generation or templates, this is not a framework. You will write all of code that exists in your project using the full power of Clojure. Everything else will be in a reusable library. You will also not have to use everything. You may use only the parts you like and forget the rest.

More details later...

h2. Running the reference project

The reference project is an idea database which demonstrates how to use the sandbar libraries.
