...
The reference application is currently easiest to get running with MySQL. Make it use Derby by default so that it will be easier for others to test drive.
