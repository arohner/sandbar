...
The vaguely named sandbar.library namespace contains a lot of code that will end up in other namespaces in the future.

h3. Authentication and Authorization

The code for authentication and authorization is located in the namespace <code>sandbar.auth</code>. For an example of how it may be used see <code>sandbar.example.ideadb.app</code>. For now the main focus is to authorized based on URIs and user roles.

h4. Configuration

One may create a security configuration that looks like this:
